...
names(corr.matrise1) <- c("Landscape variable", "GNMDS 1" )
...
knitr::kable(
  corr.matrise, 
  caption = "Correlation between landscape variables and ordination-axes"
)
